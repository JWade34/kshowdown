...
const TEAM_DATA = {
  ...
  "Siena": { id: 2561, color: "037961" },
  "Ohio State": { id: 194, color: "ce1141" },
  "TCU": { id: 2628, color: "4d1979" },
  "St. John's": { id: 2599, color: "d10000" },
  "Northern Iowa": { id: 2460, color: "473282" },
  "Kansas": { id: 2305, color: "0051ba" },
  "CA Baptist": { id: 2856, color: "000080" },
  "Louisville": { id: 97, color: "c9001f" },
  "South Florida": { id: 58, color: "004A36" },
  "Michigan St.": { id: 127, color: "18453b" },
  "N. Dakota St.": { id: 2449, color: "01402A" },
  "UCLA": { id: 26, color: "2774ae" },
  "UCF": { id: 2116, color: "000000" },
  "UConn": { id: 41, color: "0c2340" },
  "Furman": { id: 231, color: "582c83" },
  // West
  "Arizona": { id: 12, color: "0c234b" },
  "Long Island": { id: 112358, color: "50c9f7" },
  "Villanova": { id: 222, color: "00205b" },
  "Utah State": { id: 328, color: "00263a" },
  "Wisconsin": { id: 275, color: "c4012f" },
  "High Point": { id: 2272, color: "330072" },
  "Arkansas": { id: 8, color: "a41f35" },
  "Hawai'i": { id: 62, color: "003420" },
  "BYU": { id: 252, color: "003da5" },
  "Gonzaga": { id: 2250, color: "041e42" },
  "Kennesaw St.": { id: 338, color: "fdbb30" },
  "Miami": { id: 2390, color: "005030" },
  "Missouri": { id: 142, color: "f1b82d" },
  "Purdue": { id: 2509, color: "CEB888" },
  "Queens": { id: 2511, color: "192C66" },
  // South
  "Florida": { id: 57, color: "0021a5" },
  "Clemson": { id: 228, color: "f56600" },
  "Iowa": { id: 2294, color: "000000" },
  "Vanderbilt": { id: 238, color: "866D4B" },
  "McNeese": { id: 2377, color: "00529C" },
  "Nebraska": { id: 158, color: "d00000" },
  "Troy": { id: 2653, color: "AE0210" },
  "North Carolina": { id: 153, color: "7bafd4" },
  "VCU": { id: 2670, color: "ffaf00" },
  "Illinois": { id: 356, color: "ff5f05" },
  "Penn": { id: 219, color: "082A74" },
  "Saint Mary's": { id: 2608, color: "d80024" },
  "Texas A&M": { id: 245, color: "500000" },
  "Houston": { id: 248, color: "c92a39" },
  "Idaho": { id: 70, color: "000000" },
  // Midwest
  "Michigan": { id: 130, color: "00274c" },
  "Georgia": { id: 61, color: "ba0c2f" },
  "Saint Louis": { id: 139, color: "00539C" },
  "Texas Tech": { id: 2641, color: "cc0000" },
  "Akron": { id: 2006, color: "00285e" },
  "Alabama": { id: 333, color: "9e1632" },
  "Hofstra": { id: 2275, color: "003594" },
  "Tennessee": { id: 2633, color: "ff8200" },
  "Virginia": { id: 258, color: "232d4b" },
  "Wright St.": { id: 2750, color: "cba052" },
  "Kentucky": { id: 96, color: "0033a0" },
  "Santa Clara": { id: 2541, color: "690b0b" },
  "Iowa State": { id: 66, color: "822433" },
  "Tennessee St.": { id: 2634, color: "171796" },
  // First Four teams
  "SMU": { id: 2567, color: "354ca1" },
  "Miami OH": { id: 193, color: "a4000c" },
  "NC State": { id: 152, color: "cc0000" },
  "Texas": { id: 251, color: "BF5700" },
  "Howard": { id: 47, color: "003a63" },
  "UMBC": { id: 2378, color: "000000" },
  "Lehigh": { id: 2329, color: "6c2b2a" },
  "Prairie View": { id: 2504, color: "4d0960" },
  // First Four TBD placeholders
  "TBD": { id: 0, color: "666666" },
};

function getTeamLogo(name) {
  const t = TEAM_DATA[name];
  if (!t || t.id === 0) return null;
  return `https://a.espncdn.com/i/teamlogos/ncaa/500/${t.id}.png`;
}
